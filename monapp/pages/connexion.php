				...
				<div class="row">
					<div class="col-md-4 col-md-offset-4">
						<div class="card card-signup">
							...
							<form method="POST" action="connexion_traitement.php" class="form" >
								...
								<div class="content">
									...
									<div class="input-group">
										...
										<input type="password" placeholder="Password..." class="form-control" name="mot_de_passe" />
									</div>
								...
								<div class="footer text-center">
									<input type="submit" name="ajout_connect" value= "Se connecter" />
								</div>
