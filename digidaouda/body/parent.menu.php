...
function getListeElevesParent($opt="#"){
    ?>
    <ul aria-expanded="false" class="collapse">
        <li><a href="#">Saliou </a></li>
    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <ul id="sidebarnav">
                ...
                <li class="nav-label">Devoirs</li>
                <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-tachometer"></i><span class="hide-menu">Calendrier</span></a>
                        <?php getListeElevesParent(); ?>
                </li>
                <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-tachometer"></i><span class="hide-menu">Notes</span></a>
                    <?php getListeElevesParent(); ?>
                </li>
                <li class="nav-label">Absences</li>
                <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-tachometer"></i><span class="hide-menu">Justifiées<span class="label label-rouded label-success pull-right">2</span></span></a>
                    <?php getListeElevesParent(); ?>
                </li>
                <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-tachometer"></i><span class="hide-menu">Non justifiées<span class="label label-rouded label-warning pull-right">2</span></span></a>
                    <?php getListeElevesParent(); ?>
                </li>
                <li class="nav-label">Bulletins</li>
                <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-tachometer"></i><span class="hide-menu">Provisoire</span></a>
                    <?php getListeElevesParent(); ?>
                </li>
                <?php /* ?>
