                    ...
                    <div class="col-lg-6">
                        <div class="card card-outline-primary">
                            <div class="card-header" style="background: green;">
                               <center> <h4 class="m-b-0 text-white">Creer un type de <?php echo $type_compte; ?> </h4></center>
                            </div>
                            <div class="card-body"> 
                                ...
                                <form action="pages/insert.php" method="post">
                                    ...
                                    <input type="text" name="nomtype" id="lastName" class="form-control form-control-danger" placeholder="Nom du type de compte">               
                                                      </div>
                                            </div>
                                            <!--/span-->
