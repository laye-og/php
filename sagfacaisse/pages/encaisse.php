 ...
 function validation($val)
{
 ...
 try {
	...
	if(validation($_POST['piece']) && validation($_POST['daate']) && validation($_POST['Observation'])&& validation($_POST['Montant'])&& validation($_POST['compte'])&& validation($_POST['Montant'])&& validation($_POST['datereel']))
	...
	exit ();
					...
					try {
						$req='INSERT INTO Entrée(Piéce,Daate,Observation,Montant,Compte,datereel) VALUES (?,?,?,?,?,?)';
